...
export default function RestaurantQRCodePage() {
  ...
  const [activeTab, setActiveTab] = useState<"display" | "customize">("display");
  const [welcomeMessage, setWelcomeMessage] = useState("Welcome to our Restaurant!");
  const [specialOffer, setSpecialOffer] = useState("10% off your first order when you sign up today!");
  ...
  const analytics = {
    ...
    recentSignups: [
      { id: "ET", name: "Emma Thompson", table: "Table 7", time: "5 minutes ago" },
      { id: "MC", name: "Michael Chen", table: "Table 3", time: "15 minutes ago" },
      { id: "SR", name: "Sophia Rodriguez", table: "Bar", time: "32 minutes ago" },
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        setRedirectUrl(`https://users.netwok.app/register?restaurantId=${restaurantId}&qrCodeNumber=${response.data.var_id}`);
  ...
  const generateQRCode = async () => {
    try {
      ...
      setRedirectUrl(`https://users.netwok.app/register?restaurantId=${restaurantId}&qrCodeNumber=${response.data.restaurant.var_id}`);
  ...
  return (
    <div className="container max-w-6xl mx-auto p-4">
      <div className="flex items-center mb-6">
        <Button variant="ghost" size="icon" className="mr-2" onClick={backToDash}>
            ...
            <TabsContent value="display" className="mt-0">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Display this QR code in your restaurant for customers to scan and sign up</CardDescription>
                </CardHeader>
                <CardContent className="flex flex-col items-center">
                  <div className="text-center mb-4">
                   
                    Welcome to {restaurantName}!
                    {showOffer && <div className="text-sm text-gray-600 mt-1">{specialOffer}</div>}
                  </div>
                  ...
                  <div className="w-full text-center">
                    <p className="text-sm text-gray-500">Scan to connect with us!</p>
                    <div className="flex items-center justify-center mt-2 text-xs text-gray-500">
                      <span>or visit: </span>
                      <span className="ml-1 text-blue-600">{redirectUrl}</span>
                      <Button variant="ghost" size="icon" className="h-6 w-6 ml-1" onClick={copyToClipboard}>
                ...
                <CardFooter className="flex justify-between">
                  <Button variant="outline" className="flex items-center text-sm px-0.5">
              ...
              <Card className="mt-6">
                <CardHeader>
                  ...
                  <CardDescription>Learn how to use your QR code effectively</CardDescription>
                </CardHeader>
                <CardContent>
                  <ol className="space-y-4">
                    <li className="space-y-1">
                      <div className="font-medium">1. Place your QR code</div>
                      <div className="text-sm text-gray-500">Display it on tables, at the entrance, or on menus where customers can easily see it.</div>
                    </li>
                    <li className="space-y-1">
                      <div className="font-medium">2. Customers scan the code</div>
                      <div className="text-sm text-gray-500">When scanned, customers are directed to your sign-up page.</div>
                    </li>
                    <li className="space-y-1">
                      <div className="font-medium">3. Customers sign up</div>
                      <div className="text-sm text-gray-500">They create an account and can immediately start chatting with your staff.</div>
                    </li>
                    <li className="space-y-1">
                      <div className="font-medium">4. Connect with customers</div>
                      <div className="text-sm text-gray-500">Respond to messages, provide information, and enhance their dining experience.</div>
                    </li>
                  </ol>
                </CardContent>
              </Card>
            ...
            <TabsContent value="customize" className="mt-0">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Personalize how your QR code looks and what information it displays</CardDescription>
                </CardHeader>
                <CardContent className="space-y-6">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      ...
                      <p className="text-sm text-gray-500">Display your logo in the center of the QR code</p>
                    </div>
                    <Switch 
                      id="show-logo" 
                      checked={showLogo}
                  ...
                  <div className="space-y-2">
                    ...
                    <Select value={qrSize} onValueChange={(value) => setQrSize(value as QrSize)}>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      ...
                      <p className="text-sm text-gray-500">Show a special offer to encourage sign-ups</p>
                    </div>
                    <Switch 
                      id="special-offer" 
                      checked={showOffer}
                  ...
                  <Button className="w-full bg-gray-900 text-white hover:bg-gray-800" onClick={applyChanges}>
                    Apply Changes
                  </Button>
                </CardContent>
              </Card>
              ...
              <Card className="mt-6">
                <CardHeader>
                  ...
                  <CardDescription>Configure additional settings for your QR code</CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <p className="text-xs text-gray-500 mt-1">This is the URL customers will be directed to when they scan your QR code</p>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex justify-between items-center">
                      <div className="text-sm text-gray-500">
                        ...
                        <p className="text-xs">Current code expires in: <Timer key={expiryTime} expiryDate={expiryTime} onExpire={generateQRCode} /></p>
                      </div>
        ...
        <div className="md:col-span-2">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Track how customers are interacting with your QR code</CardDescription>
            </CardHeader>
            <CardContent>
              ...
              <div className="mb-6">
                <h4 className="text-sm font-medium mb-4">Scan Activity (Last 7 Days)</h4>
          ...
          <Card className="mt-6">
            <CardHeader>
              ...
              <CardDescription>People who recently signed up via your QR code</CardDescription>
            </CardHeader>
            <CardContent>
