...
const activityLogs = [
  ...
  },
  {
    ...
    user: "admin@netwok.com",
    timestamp: "2023-06-19T09:05:00Z",
    category: "user",
  },
  {
    id: 6,
...
export default function ActivityLogPage() {
  ...
  const filteredLogs = activityLogs.filter(log => {
    ...
    // Category filter
    const matchesCategory = categoryFilter === null || categoryFilter === "all" || log.category === categoryFilter
  ...
  const getCategoryColor = (category: string) => {
    switch(category) {
      case "venue": return "border-purple-500 text-purple-500"
      case "payment": return "border-green-500 text-green-500"
      case "subscription": return "border-pink-500 text-pink-500"
      case "user": return "border-blue-500 text-blue-500"
      case "system": return "border-orange-500 text-orange-500"
      case "coupon": return "border-yellow-500 text-yellow-500"
      case "support": return "border-indigo-500 text-indigo-500"
              ...
              <div className="flex flex-col gap-4">
                  ...
                  <div className="flex flex-wrap gap-2">
                    ...
                    <DropdownMenu>
                      <DropdownMenuTrigger asChild>
                        <Button variant="outline" size="sm" className={categoryFilter ? "bg-purple-50 dark:bg-purple-950" : ""}>
                      ...
                      <DropdownMenuContent align="end">
                        ...
                        {categories.map(category => (
                          <DropdownMenuItem 
                            ...
                            className={categoryFilter === category ? "bg-purple-50" : ""}
                          >
                    ...
                    <DropdownMenu>
                      <DropdownMenuTrigger asChild>
                        <Button variant="outline" size="sm" className={dateFilter ? "bg-blue-50 dark:bg-blue-950" : ""}>
                          <Calendar className="mr-2 h-4 w-4" />
                          {dateFilter === "today" ? "Today" :
                           dateFilter === "last7days" ? "Last 7 days" :
                           dateFilter === "last30days" ? "Last 30 days" : "Filter by Date"}
                          <ChevronDown className="ml-2 h-4 w-4" />
                        </Button>
                      </DropdownMenuTrigger>
                      <DropdownMenuContent align="end">
                ...
                <div className="space-y-4">
                  {filteredLogs.map((log) => (
                    <div key={log.id} className="flex flex-col sm:flex-row gap-4 p-4 border rounded-lg">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="mt-2 text-sm text-muted-foreground">By: {log.user}</div>
                      </div>
                    </div>
                  ))}
                </div>
