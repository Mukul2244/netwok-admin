    ...
    <div className="min-h-screen bg-gray-950 text-gray-200 flex flex-col">
        ...
        <div className="w-full max-w-md">
          ...
          <Card className="bg-gray-900/80 backdrop-blur-md border-0 shadow-2xl overflow-hidden rounded-2xl">
            ...
            <CardContent className="p-5">
              ...
              >
                {step === 1 && <VenueDetails onNext={goToNextStep} />}
              </div>
              ...
              >
                {step === 2 && (
                  <VenueLocation onNext={goToNextStep}  />
                )}
              </div>
              ...
              >
                {step === 3 && (
                  <AccountSetup onNext={goToNextStep}  />
                )}
              </div>
      ...
      <footer className="relative z-10 p-4 text-gray-500 text-xs text-center">
        ...
        <div className="flex justify-center gap-4 mt-2">
          <Link href="https://netwok.app/terms" className="hover:text-gray-300 transition-colors">
            Terms
          </Link>
          <Link
            href="https://netwok.app/privacy"
